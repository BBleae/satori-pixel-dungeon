...
import studio.baka.satoripixeldungeon.items.Torch;
import studio.baka.satoripixeldungeon.items.armor.curses.Bulk;
...
import studio.baka.satoripixeldungeon.items.wands.WandOfCorrosion;
import studio.baka.satoripixeldungeon.items.wands.WandOfCorruption;
import studio.baka.satoripixeldungeon.items.weapon.curses.Wayward;
import studio.baka.satoripixeldungeon.items.weapon.enchantments.Lucky;
import studio.baka.satoripixeldungeon.items.weapon.melee.Dagger;
import studio.baka.satoripixeldungeon.items.weapon.melee.Flail;
import studio.baka.satoripixeldungeon.items.weapon.melee.Greataxe;
