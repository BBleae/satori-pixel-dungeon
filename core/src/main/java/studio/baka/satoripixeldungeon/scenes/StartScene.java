...
import studio.baka.satoripixeldungeon.windows.WndGameInProgress;
...
public class StartScene extends PixelScene {
    ...
    private static class SaveSlotButton extends Button {
        ...
        public void set(int slot) {
            ...
            if (newGame) {
                ...
                if (hero == null) {
                    ...
                    classIcon.copy(Objects.requireNonNull(Icons.get(info.heroClass)));
                }
        ...
        protected void onClick() {
            if (newGame) {
                SatoriPixelDungeon.scene().add(new WndStartGame(slot));
            } else {
                SatoriPixelDungeon.scene().add(new WndGameInProgress(slot));
            }
        }
    }
}
