...
import studio.baka.satoripixeldungeon.levels.CavesBossLevel;
import studio.baka.satoripixeldungeon.levels.CavesLevel;
import studio.baka.satoripixeldungeon.levels.CityBossLevel;
import studio.baka.satoripixeldungeon.levels.CityLevel;
import studio.baka.satoripixeldungeon.levels.DeadEndLevel;
import studio.baka.satoripixeldungeon.levels.HallowBossLevel;
import studio.baka.satoripixeldungeon.levels.HallowLevel;
import studio.baka.satoripixeldungeon.levels.HallsBossLevel;
import studio.baka.satoripixeldungeon.levels.HallsLevel;
import studio.baka.satoripixeldungeon.levels.LastLevel;
import studio.baka.satoripixeldungeon.levels.LastShopLevel;
import studio.baka.satoripixeldungeon.levels.Level;
import studio.baka.satoripixeldungeon.levels.NewPrisonBossLevel;
import studio.baka.satoripixeldungeon.levels.PrisonLevel;
import studio.baka.satoripixeldungeon.levels.SewerBossLevel;
import studio.baka.satoripixeldungeon.levels.SewerLevel;
import studio.baka.satoripixeldungeon.levels.SurfaceLevel;
...
import studio.baka.satoripixeldungeon.utils.DungeonSeed;
...
public class Dungeon {
	...
	public static Level newLevel() {
		...
		switch (depth) {
			...
			case 28:
			case 29:
				level = new HallowLevel();
				break;
			case 30:
				level = new HallowBossLevel();
				break;
			default:
	...
	public static boolean souNeeded() {
		...
		if (isChallenged(Challenges.NO_SCROLLS)){
			souLeftThisSet = Math.round(1.5f - (LimitedDrops.UPGRADE_SCROLLS.count - (depth / 5) * 2f));
		} else {
			souLeftThisSet = 3 - (LimitedDrops.UPGRADE_SCROLLS.count - (depth / 4)*2);
		}
